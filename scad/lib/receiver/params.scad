...
fs_z0   = 0.8;                       // field stop front face (into the flange plate)
fs_z1   = fs_z0 + 1.4;               // field stop back / filter front face
...
assert(fring_d + 2 <= neck_bore,
    "filter retainer thread does not fit the stem neck bore.");
